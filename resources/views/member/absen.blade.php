...
<head>
    ...
    <title>SISTEM ABSENSI SMK ASSALAAM</title>
...
<td colspan="5" class="text-center success">keterangan</td><td  colspan="5" class="text-center success">Nama Petugas</td>
...
<tr>
<td colspan="2" class="text-center success">Sakit</td>
<td colspan="2" class="text-center success">Izin</td>
<td  colspan="2" class="text-center success">Alfa</td>
...
<tr>
<td colspan="2" class="text-center">{{ $jumlahSakit }}</td>
<td colspan="2" class="text-center">{{ $jumlahIzin }}</td>
<td colspan="2" class="text-center">{{ $jumlahAlfa }}</td>                   
